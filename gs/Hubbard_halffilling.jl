...
V_phys = Vect[I]((0,-1) => 1, (1,0) => 2, (0,1) => 1);
V_phys = Vect[I]((0,0) => 1, (1,1) => 2, (0,2) => 1);
V_phys_s = Vect[I]((0,-Q) => 1, (1,P-Q) => 2, (0,2*P-Q) => 1);
V_aux = Vect[I](unique(Dict((0,-Q) => 1, (0,P-1-Q) => 1, (0,2*P-2-Q) => 1)))
V_triv = Vect[I]((0,0) => 1)
...
V_virt_s = [Vect[I](get_charge_sectors(c)) for c = 0:Q]
...
for r in 1:Nr, c in 1:Nc
    ...
    # For not-halffilling?? PEPS_data[r, c] = randn(T, V_phys_s, V_phys_s ⊗ V_virt_s[mod1(c+1,Q)] ⊗ V_phys_s' ⊗ V_virt_s[mod1(c,Q)]')
    PEPS_data[r, c] = randn(T, V_phys_s, V_phys_s ⊗ V_virt_s[mod1(c+1,w)] ⊗ V_phys_s' ⊗ V_virt_s[mod1(c,w)]')
end
